...
var i, headerSwiper = new Swiper(".page-swiper", {
        slidesPerView: "1",
        navigation: {
            nextEl: ".slider-next",
            prevEl: ".slider-prev",
    ...
    acc = document.getElementsByClassName("menu-categories__name");
...
var productCounter = function () {
    document.querySelectorAll(".info-counter__btn").forEach((function (e) {
        e.addEventListener("click", (function () {
            var e, t = this.dataset.direction,
                n = this.parentElement.querySelector(".info-counter__input"),
                o = +n.value;
            e = "plus" === t ? o + 1 : o - 1 > 1 ? o - 1 : 1, n.value = e
        }))
    }))
};
productCounter();
var menuIcon = document.querySelector(".header-menu__icon"),
    mobMenu = document.querySelector(".header-menu_mob");
menuIcon.addEventListener("click", (function () {
    menuIcon.classList.toggle("active"), mobMenu.classList.toggle("active")
}));
var menuIconFooter = document.querySelector(".footer-menu__icon"),
    mobMenuFooter = document.querySelector(".footer-menu__body"),
    footer = document.querySelector(".footer");
menuIconFooter.addEventListener("click", (function () {
    menuIconFooter.classList.toggle("active"), mobMenuFooter.classList.toggle("active"), footer.classList.toggle("active")
}));
...
galleryThumbs.controller.control = galleryTop, galleryTop.controller.control = galleryThumbs;
